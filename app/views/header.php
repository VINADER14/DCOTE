...
<body>
    <svg style="display: none;">
        ...
        <symbol id="close-cross" viewBox="0 0 24 24">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" fill="none" d="M18 6l-12 12" />
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" fill="none" d="M6 6l12 12" />
        </symbol>
    ...
    <nav class="navbar">
        ...
        <div class="right">
            <button class="login-btn scale-in" onclick="window.location.href='<?= (isset($_SESSION['verified']) && $_SESSION['verified']) ? '/account' : '/login' ?>'"><?= (isset($_SESSION['verified']) && $_SESSION['verified']) ? 'АККАУНТ' : 'ВОЙТИ' ?></button>
        </div>
        <div class="right-mobile">
            <button class="login-btn-mobile" onclick="window.location.href='/login'">ВОЙТИ</button>
            <button class="hamburger" id="hamburgerBtn"><svg width="30" height="30">
        ...
        <div class="side-menu" id="sideMenu">
            <div class="side-links">
                <div class="side-link-first-line">
                    ...
                    <button class="close-btn" id="closeMenu"><svg width="25" height="25">
                            <use href="#close"></use>
                        </svg></button>
                </div>
