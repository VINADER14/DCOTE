        ...
        <div class="auth-container">
            ...
            <div class="auth-form scale-in slide-in-left">
                <form method="POST" id="registration-form" novalidate>
                    ...
                    <div class="input-group">
                        <label for="tag"><h3>Имя пользователя</h3></label>
                        <input id="tag" value="<?= e($old['tag'] ?? '') ?>"  name="tag" data-required>
                    </div>
                    <div class="input-group">
                        <label for="nickname"><h3>Отображаемое имя</h3></label>
                        <input id="nickname" value="<?= e($old['nickname'] ?? '') ?>"  name="nickname" data-required>
                    </div>
                    <div class="input-group">
                        <div class="password-title"><label for="password"><h3>Пароль</h3></label><div class="password-info"><svg class="info-icon" width="24" height="24"><use href="#info-circle"></use></svg>
                        <div class="password-tooltip">
                            <div class="tooltip-text"><h3>Требования к паролю</h3>
                            <p>Не менее 6 символов<br>
                            Не менее 1 буквы<br>
                            Не менее 1 цифры</p></div>
                        </div></div>
                    </div>
